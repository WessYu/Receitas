      ...
      <div className="container-page grid gap-10 py-8 lg:grid-cols-[0.7fr_1.3fr] lg:py-12">
              ...
              {ingredients.map((ingredient) => {
                ...
                return (
                  <button
                    ...
                    className="flex w-full items-center gap-3 rounded-[12px] border border-white/10 bg-[#141417] px-4 py-3 text-left"
                  >
        ...
        <section className="flex min-h-[520px] flex-col justify-between rounded-[20px] border border-white/10 bg-[#141417] p-6 sm:p-10">
          <div>
            ...
            <p className="mt-12 max-w-3xl font-serif text-3xl leading-[1.25] text-[#F5F5F3] sm:text-5xl">
