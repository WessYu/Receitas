...
export function AdminSidebar() {
  return (
    <aside className="rounded-lg border border-ink/10 bg-white/75 p-3 shadow-sm lg:sticky lg:top-24 lg:h-fit">
        ...
        {links.map((link) => {
          ...
          return (
            <Link
              key={link.href}
              href={link.href}
              className="flex items-center gap-3 rounded-md px-3 py-3 text-sm font-semibold text-ink/70 transition hover:bg-olive/10 hover:text-ink"
            >
